...
namespace RTGSCBS.FloraCPSWS {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Service1() {
            this.Url = global::RTGSCBS.Properties.Settings.Default.CPSCBS_FloraCPSWS_Service1;
        ...
        public System.Data.DataSet GetAccountInfo(string AccountNo) {
        ...
        public string QueryTransaction(string XREF, string branch) {
        ...
        /// <remarks/>
        public void QueryTransactionAsync(string XREF, string branch) {
            this.QueryTransactionAsync(XREF, branch, null);
        }
        
        /// <remarks/>
        public void QueryTransactionAsync(string XREF, string branch, object userState) {
            ...
            this.InvokeAsync("QueryTransaction", new object[] {
                        XREF,
                        branch}, this.QueryTransactionOperationCompleted, userState);
        }
        ...
        public string InwardTransaction(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch) {
        ...
        /// <remarks/>
        public void InwardTransactionAsync(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch) {
            this.InwardTransactionAsync(branch, XREF, HV, remAccount, benefAccount, checkSlNo, CCY, amount, txnDate, valDate, insDate, routingNo, txnBrn, remBranch, null);
        }
        
        /// <remarks/>
        public void InwardTransactionAsync(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch, object userState) {
            ...
            this.InvokeAsync("InwardTransaction", new object[] {
                        ...
                        routingNo,
                        txnBrn,
                        remBranch}, this.InwardTransactionOperationCompleted, userState);
        }
        ...
        public string OutwardTransaction(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch) {
        ...
        /// <remarks/>
        public void OutwardTransactionAsync(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch) {
            this.OutwardTransactionAsync(branch, XREF, HV, remAccount, benefAccount, checkSlNo, CCY, amount, txnDate, valDate, insDate, routingNo, txnBrn, remBranch, null);
        }
        
        /// <remarks/>
        public void OutwardTransactionAsync(string branch, string XREF, string HV, string remAccount, string benefAccount, string checkSlNo, string CCY, string amount, string txnDate, string valDate, string insDate, string routingNo, string txnBrn, string remBranch, object userState) {
            ...
            this.InvokeAsync("OutwardTransaction", new object[] {
                        ...
                        routingNo,
                        txnBrn,
                        remBranch}, this.OutwardTransactionOperationCompleted, userState);
        }
